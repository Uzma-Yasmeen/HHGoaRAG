...
type Source = { id: string; text: string; language: string; score: number; strategy?: string; title?: string; source_url?: string };
...
const sampleQuestions: Record<string, string[]> = {
  en: ["What is the capital of Goa?", "When was Goa liberated?", "How many planets are in the solar system?"],
  hi: ["गोवा की राजधानी क्या है?", "गोवा कब मुक्त हुआ था?", "सौरमंडल में कितने ग्रह हैं?"],
  te: ["గోవా రాజధాని ఏది?", "గోవా ఎప్పుడు విముక్తి పొందింది?", "సౌర వ్యవస్థలో ఎన్ని గ్రహాలు ఉన్నాయి?"],
};
